...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/snakeviz-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6438&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/snakeviz-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `snakeviz` can be installed with:

```
conda install snakeviz
```

It is possible to list all of the versions of `snakeviz` available on your platform with:
